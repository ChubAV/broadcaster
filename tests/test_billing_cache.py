...
СТАРАЯ ПАРА `check_balance_cached` / `invalidate_balance_cache` ЖИВА И ЗДЕСЬ НЕ
ПРОВЕРЯЕТСЯ. Её снимает план `05.1-06` вместе с самим списанием сообщений; до
того момента путь отправки обязан быть закрыт хотя бы одним из двух гейтов.
"""
import pytest
