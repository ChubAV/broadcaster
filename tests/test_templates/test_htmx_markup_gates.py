...
#
# ЛЕТОПИСЬ: 0 → 1, Фаза 9, план 09-01 (макрос-обёртка формы). План 09-02
# поднимает число до 2; Фаза 10, переносящая проверку адреса на вызывающих,
# обязана опустить его до нуля либо обосновать заново.
MACRO_DEFINITION_SITES_DECLARED = 1
