...
#
# ЛЕТОПИСЬ ЧИСЛА: 6 → 7, Фаза 9, план 09-01.
#
...
# 09-01, удаление — план 09-02), и обход считает ФАЙЛЫ: вторая копия узла
# подняла бы это число ещё раз и означала бы, что две линейки разъедутся молча.
OOB_BLOCKS = 7
