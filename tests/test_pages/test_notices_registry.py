...
3. ГЕЙТ ПЕРЕНОСА ДЕРЖИТ ОДИННАДЦАТЬ СТРОК, А НЕ ПЯТНАДЦАТЬ. Одиннадцать —
   это те, что переехали из отображений «код → текст» на Python. Оставшиеся
   четыре имеют другое происхождение и другим гейтом не покрываются: текст
   смены пароля жил в разметке экрана входа, текст отказа под чужой учётной
   записью уезжал телом ответа 403, текст сохранения профиля НОВЫЙ —
