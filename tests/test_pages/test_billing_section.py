...
- Арифметики осей тарифа: её предмет снят планом 05.1-07 вместе с модулем метров
  и матрицей тарифов. Осей на экране нет, считать нечего, и строка про их
  контракт оставлена ЗАЧЁРКНУТОЙ, а не стёрта: перечень «чего здесь нет» служит
  следующему читателю картой, и молчание об исчезнувшем разделе он прочёл бы как
  пропуск покрытия.
