...
from app.services.image_upload import MAX_UPLOAD_PARTS, STORAGE_UNAVAILABLE_MESSAGE
...
async def test_too_many_parts_is_a_readable_row_not_json(
    ...
    assert str(MAX_UPLOAD_PARTS) in reason, (
        f"причина отказа {reason!r} не называет предела числа файлов — человек "
        "не знает, насколько меньше выбрать в следующий раз"
    )
