...
# Летопись числа: ПОСТАВЛЕНО ПРОГОНОМ покрасневшего правила ниже (план 10-14,
# 2026-09-04), а не переписано из плана. Ориентир плана — 41 — оказался числом
# требований ВЕХИ v2.1; таблица несёт СВЕРХ них три строки, отложенные к v2.2.
REQUIREMENT_ROWS_DECLARED = 0  # ⚠️ НЕ ИЗМЕРЕНО — ставится прогоном
