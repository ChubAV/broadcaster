...
number: 6
name: Зазор под кнопками — ПЕРЕНАБЛЮДЕНИЕ после закрытия G-11-6, вместе с пунктом 5а (наложение точки на орган)
expected: |
  Лишней полосы и хвоста нет ни в одной из трёх форм; точка читается признаком занятости, не
  закрывает подпись, не садится на ручку включённого тумблера, не гасит нажатие по углу, не
  срезана краем карточки; панель подтверждения выглядит как прежде.
