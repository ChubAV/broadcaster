...
updated: 2026-08-29T10:20:29.051Z
---

## Current Test

number: 1
name: Действие, отвергнутое гейтом доступа (истёкшая подписка), и действие под чужой личностью — в ЖИВОМ браузере с включённым JavaScript
expected: |
  Браузер уходит по `HX-Location`, и на приземлившемся экране видно СЛОВО об отказе
  (область `#notice` / `#notice-alert`), а не тишина и не прежний экран
