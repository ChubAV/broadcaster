...
fixed_count: 2
total_count: 11
last_updated: 2026-08-27T10:23:15.664Z
---
...
| 11 | 07 | unrun-verify | .planning/phases/07-obnovlenie-htmx-do-2-0-10-i-blok-konfiguratsii/07-UAT.md |  | Ручной обход 07-UAT.md создан, отметки НЕ заполнены: поведенческие половины FOUND-01 и QUAL-05 закрываются глазами на приёмке фазы | open |  | 2026-08-27T10:23:15.664Z |  |
...
[
  ...
  },
  {
    ...
    "line": null,
    "description": "Ручной обход 07-UAT.md создан, отметки НЕ заполнены: поведенческие половины FOUND-01 и QUAL-05 закрываются глазами на приёмке фазы",
    "status": "open",
    "reason": "",
