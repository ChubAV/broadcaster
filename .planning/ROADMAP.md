...
- [ ] 04-04-PLAN.md — Heatmap 7×24 в таймзоне пользователя, ближайшие отправки с пометками причин, поблочные пустые состояния (DASH-02, DASH-04)
...
| 4. Дашборд и история | 3/10 | In Progress|  |
