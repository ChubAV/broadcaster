...
- [ ] 03-01-PLAN.md — Сквозной срез: экран групп аккаунта, тумблер и пропуск выключенных при рассылке (GRP-04, GRP-05)
- [ ] 03-02-PLAN.md — Схема результата синка: колонки, ревизия `0014` и единый хелпер переинвентаризации (GRP-07)
- [ ] 03-03-PLAN.md — Выключенные, но выбранные группы видны в редакторе объявления (GRP-05, D-07)
