...
**Plans**: 4/7 plans executed (волны 1–7, последовательные — планы делят одни и те же файлы)
...
- [ ] 02-05-PLAN.md — Расписания внутри редактора объявления (D-07, D-08, D-09)
...
| 2. Объявления и расписания | 4/7 | In Progress|  |
