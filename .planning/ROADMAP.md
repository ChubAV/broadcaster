...
- [ ] 04-10-PLAN.md — Одно определение сводки по журналу, фазовый гейт суиты, пересборка графа, ручная приёмка пяти непокрываемых поведений
...
| 4. Дашборд и история | 9/10 | In Progress|  |
