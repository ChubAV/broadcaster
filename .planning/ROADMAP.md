...
- [ ] 01-04-PLAN.md — Разделы «Расписания» и «Группы», общий макрос сворачиваемых фильтров
...
- [ ] 01-06-PLAN.md — Раздел «Аккаунты»: якоря подмены, самоостанавливающийся опрос, три мастера подключения
...
|-------|----------------|--------|-----------|
| 1. Интерфейсный фундамент | 3/8 | In Progress|  |
