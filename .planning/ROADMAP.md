...
**Plans**: 12 plans (7/7 исполнены, волны 1–7; 5 планов закрытия пробелов после верификации, волны 8–11)
...
- [ ] 02-08-PLAN.md — Трассирующий: замыкание контракта автосохранения — повторный запрос обновляет тот же черновик (CR-01, SC-1, SC-2)
...
| 2. Объявления и расписания | 7/7 | In Progress|  |
