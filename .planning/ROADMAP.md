...
**Plans**: 3/7 plans executed (волны 1–7, последовательные — планы делят одни и те же файлы)
...
- [ ] 02-04-PLAN.md — Редактор: автосохранение, вложения плитками, серверный предпросмотр (D-03…D-13)
...
| 2. Объявления и расписания | 3/7 | In Progress|  |
