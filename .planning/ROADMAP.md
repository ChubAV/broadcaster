...
- [ ] 04-09-PLAN.md — Повтор из истории: предпроверка, гейт баланса, заявка против двойного нажатия, панель подтверждения (HIST-04)
...
| 4. Дашборд и история | 8/10 | In Progress|  |
