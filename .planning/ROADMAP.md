...
**Plans**: 2/7 plans executed (волны 1–7, последовательные — планы делят одни и те же файлы)
...
- [ ] 02-03-PLAN.md — Tracer: состояние объявления сквозным срезом, миграция `0013`, пропуск черновиков планировщиком (D-01, D-02)
...
| 2. Объявления и расписания | 2/7 | In Progress|  |
