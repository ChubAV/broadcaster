...
**Plans**: 5/7 plans executed (волны 1–7, последовательные — планы делят одни и те же файлы)
...
- [ ] 02-06-PLAN.md — Снос `/schedules/new` и `/schedules/{id}/edit` (D-14, D-16)
...
| 2. Объявления и расписания | 5/7 | In Progress|  |
