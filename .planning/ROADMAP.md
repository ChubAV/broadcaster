...
- [ ] **Phase 3: Группы аккаунта** - Экран групп конкретного messenger-аккаунта с включением, удалением и повторной синхронизацией.
...
| 3. Группы аккаунта | 12/12 | In Progress|  |
