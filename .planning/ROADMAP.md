...
**Plans**: 13 plans — 8 executed, 5 закрывают пробелы верификации (SC-3 и SC-5)
Plans:
**Wave 1**
...
- [ ] 01-09-PLAN.md — Библиотека: параметр подписи ячейки, слот полей в модалке, удаление мёртвого includes/icons.html
- [ ] 01-10-PLAN.md — CR-01: хранимый XSS через имя загружаемого файла в редакторе объявления
...
|-------|----------------|--------|-----------|
| 1. Интерфейсный фундамент | 8/8 | In Progress|  |
