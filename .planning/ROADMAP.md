...
**Plans**: 6/7 plans executed (волны 1–7, последовательные — планы делят одни и те же файлы)
...
- [ ] 02-07-PLAN.md — Сводный список расписаний: карточки, фильтры, тумблер (D-17, D-18)
...
| 2. Объявления и расписания | 6/7 | In Progress|  |
