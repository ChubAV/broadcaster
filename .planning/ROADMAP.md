...
**Plans**: 7 plans (волны 1–7, последовательные — планы делят одни и те же файлы)

Plans:
**Wave 1**

- [ ] 02-01-PLAN.md — Проверяемая база: изоляция тестовых настроек, рендер редактора (D-21), страховочная сетка SC-3
