...
**Plans**: 11/12 plans executed — 8 исполнены, 4 закрывают пробелы верификации и регистра угроз
...
- [ ] 03-12-PLAN.md — Ревизия 0015 получает идентификатор угрозы, формулировка T-03-06 сверена с кодом, раздел переходящих находок закрыт (гигиена, требования не назначены)
...
| 3. Группы аккаунта | 11/12 | In Progress|  |
