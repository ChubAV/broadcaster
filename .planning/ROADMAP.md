...
**Plans**: 15 plans — 12/15 executed (7 исполнены, волны 1–7; 5 закрытия пробелов, волны 8–11; 3 плана второго раунда закрытия пробелов, волны 12–13)
...
- [ ] 02-13-PLAN.md — CR-04: очередь вместо отмены на форме автосохранения, контракт закреплён регрессией наложения (SC-1, SC-2)
- [ ] 02-14-PLAN.md — CR-03: отказ 422 на явный null в PUT /api/schedules и вторая линия защиты в разметке обоих экранов
...
| 2. Объявления и расписания | 12/15 | In Progress|  |
