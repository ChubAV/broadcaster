...
- [ ] 04-07-PLAN.md — Текст ошибки, ограничение по высоте с раскрытием, копирование диагностики, переверстка страницы записи (HIST-02)
- [ ] 04-08-PLAN.md — Потоковая выгрузка CSV: те же фильтры, метка порядка байтов, потолок до начала потока, экранирование формул (HIST-03)
...
| 4. Дашборд и история | 6/10 | In Progress|  |
