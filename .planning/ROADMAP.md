...
- [ ] 03-04-PLAN.md — Синхронизация как переинвентаризация: три вызова одного хелпера (GRP-07)
- [ ] 03-05-PLAN.md — Полный экран: счётчики, поиск, прокрутка, удаление, пустые состояния, адаптивность (GRP-04, GRP-06)
...
| 3. Группы аккаунта | 3/8 | In Progress|  |
