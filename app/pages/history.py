...
# Записи журнала, повтор которых отклоняется в ЭТОМ процессе. Реестр — в
# памяти, а не в БД, по образцу реестра синхронизации аккаунтов
...
# Ключ — идентификатор записи журнала, значение — момент по монотонным часам,
# ДО которого повтор этой записи отклоняется.
