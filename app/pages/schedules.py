...
# Имя обязано остаться доступным ПО ПРЕЖНЕМУ ПУТИ: два модуля суиты ввозят его
# отсюда (`tests/test_pages/test_editor_schedules.py:35` и
# `tests/test_pages/test_confirm_delete_transport.py:117`), и переезд сделан
# ПЕРЕНОСОМ ОБЪЯВЛЕНИЯ, а не переименованием потребителей. Ввоз здесь есть
# сохранённый вход, а не забытая строка.
